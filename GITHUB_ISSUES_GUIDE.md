...
This guide defines the mandatory workflow for all AI coding agents working on the **Piggy** project. Following these rules ensures project discipline, traceability, and clear progress tracking.
